...
class Room:
    ...
    def __twin_effect(self, rooms, pl, players):
    ...
    def __vortex_effect(self, rooms, pl, players):
    ...
    def __room_switch(self, rt, rooms, pl, players):
        if rt == RoomType.vision_chamber:
            ...
            return self.__twin_effect(rooms, pl, players)
        elif rt == RoomType.vortex_room:
            return self.__vortex_effect(rooms, pl, players)
        elif rt == RoomType.prison_cell:
            return self.__prison_effect(rooms, pl, players)
        elif rt == RoomType.cold_chamber:
            return self.__cold_effect(rooms, pl, players)
        elif rt == RoomType.dark_chamber:
            return self.__blind_effect(rooms, pl, players)
        elif rt == RoomType.trapped_chamber:
            return self.__trapped_effect(rooms, pl, players)
        elif rt == RoomType.mortal_chamber:
            return self.__mortal_effect(rooms, pl, players)
        elif rt == RoomType.illusion_chamber:
            return [RoomEvent(RoomEventType.illusion)]
        elif rt == RoomType.flooded_chamber:
            return self.__flooded_effect(rooms, pl, players)
        elif rt == RoomType.acid_bath:
            return self.__acid_bath(rooms, pl, players)
        else:
            return []
    ...
    def on_room_enter(self, rooms, pl, players):
        ...
        rt = self.room_type
        return event_list + self.__room_switch(rt, rooms, pl, players)
